...
class VAE(nn.Module):
    ...
    def reparameterize(self, mu, log_var):
        #reparameterization trick, which allows the model to backpropagate gradients through the random sampling operation.
        if self.training:
    ...
    def forward(self, x):
        mu, logvar = self.encode(x)  #z is laten space
